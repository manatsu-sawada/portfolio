...
For this IT career-transition portfolio, use Storytelling as a narrative and information-architecture skill, not as permission for decorative excess.

- The page must quickly answer: who this person is, what role they target, what they can build, and where proof exists.
- The reader journey should move from positioning to evidence: introduction, skills, projects, process, outcomes, contact.
- Creative visuals should support comprehension of projects and personality.
- Recruiter scanability, accessibility, and responsive readability must win over visual novelty.
